    ...
    def run(self):
        ...
        for i in range(len(self.data)):
            ...
            if signal == 'BUY' and self.cash > 0:
                ...
                trade_profit = (price - self.last_buy_price) * self.position  # Calculate profit from last buy
        ...
        #print(f"Day {i}: Portfolio Value = {portfolio_value}, Cash = {self.cash}, Position = {self.position}")
